...
#ifdef MELEE_NATIVE
typedef uintptr_t HSD_GeneratorAddress;
#else
typedef u32 HSD_GeneratorAddress;
#endif
/* 4D78F8 */ static HSD_GeneratorAddress hsd_804D78F8;
...
void hsd_8039D4DC(HSD_Generator* gen)
{
    ...
    while (cur != NULL) {
        if (cur == gen) {
            hsd_804D78F8 =
                (HSD_GeneratorAddress) hsd_8039D3AC(gen, (HSD_Generator*) hsd_804D78F8);
            if (hsd_804D78F8 != 0) {
                while (((HSD_Generator*) hsd_804D78F8)->next != NULL) {
                    hsd_804D78F8 = (HSD_GeneratorAddress) ((HSD_Generator*) hsd_804D78F8)->next;
                }
            } else if (hsd_804D78FC != NULL) {
                hsd_804D78F8 = (HSD_GeneratorAddress) hsd_804D78FC;
                while (((HSD_Generator*) hsd_804D78F8)->next != NULL) {
                    hsd_804D78F8 = (HSD_GeneratorAddress) ((HSD_Generator*) hsd_804D78F8)->next;
                }
            }
        ...
        hsd_804D78F8 = (HSD_GeneratorAddress) cur;
        cur = cur->next;
    }
}
...
void hsd_8039D688(HSD_JObj* jobj, f32** unused1, s32 unused2)
{
    ...
    while (gen != NULL) {
        ...
        if (gen->jobj == jobj) {
            ...
            hsd_804D78F8 = (HSD_GeneratorAddress) gen;
        }
        gen = next;
    }
}
    ...
    while (gen->count >= 1.0F) {
        ...
        case 7: {
            ...
            hsd_80398F0C(gen->linkNo, gen->bank, gen->kind, gen->texGroup,
                         (HSD_ParticleAddress) gen->cmdList, gen->life, 0, (HSD_ParticleAddress) gen,
        ...
        case 2: /* tornado */
        {
            ...
            hsd_80398F0C(gen->linkNo, gen->bank, gen->kind | 4, gen->texGroup,
                         (HSD_ParticleAddress) gen->cmdList, gen->life, 0, (HSD_ParticleAddress) gen, 0.0F,
...
void hsd_8039EE24(u32 mask)
{
    ...
    while (hsd_804D78F4 != 0) {
        ...
        hsd_8039D71C(gp);
        hsd_804D78F4 = (HSD_ParticleHandle) HSD_SListRemove((HSD_SList*) hsd_804D78F4);
        if (gp->jobj != NULL) {
...
HSD_Generator* hsd_8039F6CC(s32 linkNo, s32 bank, s32 gfx_id, HSD_JObj* jobj)
{
    ...
    gen->type |= (gen->kind & 0x20000) ? 0x500 : 0x700;
    hsd_804D78F4 =
        (HSD_ParticleHandle) HSD_SListAllocAndAppend((HSD_SList*) hsd_804D78F4, gen);
    return gen;
}
