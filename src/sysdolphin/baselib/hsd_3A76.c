...
#ifdef MELEE_NATIVE
static void HSD_SisLib_803A84BC_Impl(HSD_GObj* gobj, int pass,
                                     HSD_Text* pass_text);

void HSD_SisLib_803A84BC(HSD_GObj* gobj, int pass)
{
    HSD_SisLib_803A84BC_Impl(gobj, pass, (HSD_Text*) (intptr_t) pass);
}

void HSD_SisLib_803A84BC_Text(HSD_Text* text)
{
    HSD_SisLib_803A84BC_Impl(NULL, 0, text);
}
