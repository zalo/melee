...
struct grZebes_GroundVars4 {
    ...
    /* +0C gp+D0 */ f32 xD0;
    /* +10 gp+D4 */ f32 xD4;
    /* +14 gp+D8 */ grZePtr xD8;
    /* +18 gp+DC */ grZePtr xDC;
    /* +1C gp+E0 */ grZePtr xE0;
    /* +20 gp+E4 */ s16 xE4;
    /* +22 gp+E6 */ s16 xE6;
    /* +24 gp+E8 */ s32 xE8;
    /* +28 gp+EC */ grZePtr xEC;
};
...
#ifdef MELEE_NATIVE
#include <stdint.h>
typedef uintptr_t GrCastlePtr;
#else
typedef u32 GrCastlePtr;
#endif
...
#ifdef MELEE_NATIVE
        struct grZe_NativeAcidVars zebes_acid;
#endif
